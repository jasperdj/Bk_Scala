...
/**
  ...
  */
class RouteRequest[T](json:String, databaseRequest:Future[T]) extends JsonHelper{
  ...
  private def createUnitPerformance(list:List[Long], unitName:String):Map[String, Long] = {
